...
userSchema.pre('save', function (next) {
    ...
    if (typeof user.display_name == "undefined" || user.display_name == null){
        user.display_name = user.user_information.first_name + ", " + user.user_information.last_name;
    }
    if (typeof user.email == "undefined" || user.email == null){
        user.email = user.username;
    }
    if (typeof user.user_information.address.country == "undefined" || user.user_information.address.country == null){
        user.user_information.address.country = "India";
    }

    if (!user.isModified('password')) return next();

    console.log("User to be modfied to be saved:"+JSON.stringify(user));
