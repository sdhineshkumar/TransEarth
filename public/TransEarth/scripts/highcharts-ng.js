    ...
    .factory('highchartsNGUtils', function () {
        ...
        return {
            ...
            deepExtend: function deepExtend(destination, source) {
                ...
                if(typeof destination.plotOptions != 'undefined'){
                    //console.log("Destination: "+JSON.stringify(destination));
                    destination.plotOptions.series = {};
                    destination.plotOptions.series.dataLabels = {};
                    destination.plotOptions.series.dataLabels.enabled = true;
                    //console.log("Destination modified: "+JSON.stringify(destination));
                }
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.$on('highchartsng.reflow', function () {
                    //console.log('Reflowing Highcharts...');
                    chart.reflow();
                });
